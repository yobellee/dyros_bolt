...
#define MODEL_DOF_VIRTUAL_ 14
#define MODEL_DOF_QVIRTUAL_ 15
...
#define EIGEN_MAKE_TYPEDEFS(Type, TypeSuffix, Size, SizeSuffix)    \
  ...
  typedef Matrix<lScalar, MODEL_DOF_QVIRTUAL_, 1> VectorQVQf;
  typedef Matrix<lScalar, MODEL_DOF_VIRTUAL_, 1> VectorVQf;
  typedef Matrix<lScalar, MODEL_DOF_, 1> VectorQf;

  // typedef SparseMatrix<lScalar, 6, MODEL_DOF_VIRTUAL_> sp
  ...
  // EIGEN_MAKE_TYPEDEFS(rScalar, d, MODEL_DOF_, MODEL_DOF_)
  // EIGEN_MAKE_TYPEDEFS(rScalar, d, MODEL_DOF_VIRTUAL_, MODEL_DOF_VIRTUAL_)
  // EIGEN_MAKE_TYPEDEFS(rScalar, d, MODEL_DOF_QVIRTUAL_, MODEL_DOF_QVIRTUAL_)
  ...
  typedef Matrix<rScalar, MODEL_DOF_VIRTUAL_, MODEL_DOF_VIRTUAL_> MatrixVVd;
  typedef Matrix<lScalar, MODEL_DOF_VIRTUAL_, MODEL_DOF_VIRTUAL_> MatrixVVf;
  typedef Matrix<lScalar, MODEL_DOF_, MODEL_DOF_> MatrixQQf;
  typedef Matrix<lScalar, MODEL_DOF_, MODEL_DOF_VIRTUAL_> MatrixQVf;
  typedef Matrix<lScalar, MODEL_DOF_VIRTUAL_, MODEL_DOF_> MatrixVQf;

  typedef Matrix<rScalar, 12, 1> Vector12d;

  typedef Matrix<rScalar, MODEL_DOF_, 1> VectorQd;
  typedef Matrix<rScalar, MODEL_DOF_VIRTUAL_, 1> VectorVQd;
  typedef Matrix<rScalar, MODEL_DOF_QVIRTUAL_, 1> VectorQVQd;

  typedef Matrix<rScalar, 6, MODEL_DOF_VIRTUAL_> Matrix6Vd;
  typedef Matrix<rScalar, 3, MODEL_DOF_VIRTUAL_> Matrix3Vd;

  typedef Matrix<lScalar, 6, MODEL_DOF_VIRTUAL_> Matrix6Vf;
  typedef Matrix<lScalar, 3, MODEL_DOF_VIRTUAL_> Matrix3Vf;
  ...
  typedef Matrix<rScalar, 6, MODEL_DOF_> Matrix6Qd;
  typedef Matrix<rScalar, MODEL_DOF_, MODEL_DOF_> MatrixQQd;
  typedef Matrix<rScalar, MODEL_DOF_VIRTUAL_, MODEL_DOF_VIRTUAL_> MatrixVQVQd;
  typedef Matrix<rScalar, 3, MODEL_DOF_> Matrix3Qd;
 ...
 */
  ...
  static Eigen::MatrixQQd WinvCalc(const Eigen::MatrixQQd &W, Eigen::MatrixXd &V2)
  {
    ...
    int rank = qr.rank();
    if ((rank == MODEL_DOF_ - 18) || (rank == MODEL_DOF_ - 12) || (rank == MODEL_DOF_ - 6) || (rank == MODEL_DOF_))
    {
  ...
  static Eigen::MatrixXd pinv_COD(const Eigen::MatrixXd &A, Eigen::MatrixXd &V2)
  {
    ...
    if ((rank == MODEL_DOF_ - 18) || (rank == MODEL_DOF_ - 12) || (rank == MODEL_DOF_ - 6) || (rank == MODEL_DOF_))
    {
      ...
      // if(rank == MODEL_DOF_)
      // {
      //     std::cout<< "rank is MODEL_DOF_!!!!" <<std::endl;
