...
namespace odrive {
    ...
    class ODriveAxis {
        ...
        private:
            ...
            realtime_tools::RealtimePublisher<can_msgs::Frame> sent_messages_pub_;
            // ros::Publisher sent_messages_pub_;

            // ros::Subscriber cali_sub_;
            ...
            // void caliCallback(const std_msgs::Bool::ConstPtr& msg);
            // void clCallback(const std_msgs::Bool::ConstPtr& msg);
